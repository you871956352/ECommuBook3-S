...
var WavAudioEncoder = new function(sampleRate, numChannels){
    ...
    this.Encoder = function(sampleRate, numChannels) {
      this.sampleRate = sampleRate;
      this.numChannels = numChannels;
      this.numSamples = 0;
      this.dataViews = [];
    };
    this.Encoder.prototype.encode = function(buffer) {
      var min = Math.min,
          max = Math.max;
    ...
    this.Encoder.prototype.finish = function(mimeType) {
    ...
    this.Encoder.prototype.cancel = Encoder.prototype.cleanup = function() {
